...
namespace LibraryRestApi.Service
{
    public class BookTitleDbService :IBooktTitleRepository
    {
        ...
        public async Task<ICollection<BookTitle>> GetAll() => await _context.BookTitles.ToListAsync();

        public async Task<BookTitle> GetById(long id) => await _context.BookTitles.FirstOrDefaultAsync(b => b.Id == id);
